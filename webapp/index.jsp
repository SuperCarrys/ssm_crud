...
<div class="container">
    ...
    <script type="text/javascript" >
        ...
        function validate_add_form(){
            ...
            var regName = /(^[\u2E80-\u9FFF]{2,5})|(^[a-zA-Z0-9_-]{6,16})/;
            if (!regName.test(empName)) {
                //alert("用户名可以是2到5位中文或者6-16位英文和数字的组合");
                show_validate_msg("#empName_add_input", "error", "用户名可以是2到5位中文或者6-16位英文和数字的组合");
                return false;
            }else{
        ...
        $("#emp_update_btn").click(function () {
            ...
            $.ajax({
                ...
                //2.发送PUT请求,要在web-xml中配置 HttpPutFormContentFilter 拦截器
                type:"PUT",
        ...
        $("#check_all").click(function () {
            //attr获取checkde时undefined
            //这些dom原生的属性建议用prop获取， 自定的属性用attr获取
